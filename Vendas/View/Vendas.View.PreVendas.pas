...
begin
  ...
  begin
     MessageDlg('Preço Unitário não pode ser Zero' ,mtInformation,[mbOK],0);
...
begin
  ...
  begin
    ...
    if StatusVenda(dsprevendas.DataSet.Fields[3].AsString)
     then
     begin
       MessageDlg('Venda não pode ser alterada, pois, já esta Efetivada!', mtInformation, [mbOK], 0);
       Listagem(0,'');
      Abort;
     end
     else
...
begin
  ...
  begin
    ...
    if StatusVenda(dsprevendas.DataSet.Fields[3].AsString)
     then
     begin
       MessageDlg('Venda não pode ser excluída, pois, já esta Efetivada!', mtInformation, [mbOK], 0);
       Listagem(0,'');
       Abort;
     end
     else
    ...
    if (StatusCadastro=ecExcluir)
     ...
     begin
       ...
       begin
         ...
         if Result then MessageDlg('Registro excluído com sucesso!', mtInformation, [mbOK], 0);
       end
       else
         Result:= False;
     end;
